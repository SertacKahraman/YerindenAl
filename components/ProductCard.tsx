...
import { Image, Platform, Pressable, StyleProp, StyleSheet, Text, useWindowDimensions, View, ViewStyle } from 'react-native';
...
export default function ProductCard({ title, price, image, location, onPress, isFavorite, onToggleFavorite, style }: ProductCardProps) {
